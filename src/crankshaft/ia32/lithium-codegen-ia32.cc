...
void LCodeGen::HandleTaggedToSIMD128(LTaggedToSIMD128* instr) {
  ...
  DeoptimizeIf(not_equal, instr, DeoptimizeReason::kNotASIMD128);
...
void LCodeGen::DoUnarySIMDOperation(LUnarySIMDOperation* instr) {
  ...
  switch (instr->op()) {
    ...
    case kSIMD128Change: {
      ...
      DeoptimizeIf(no_condition, instr, DeoptimizeReason::kForcedDeoptToRuntime);
      return;
    }
    case kFloat32x4Abs:
    case kFloat32x4Neg:
...
void LCodeGen::DoBinarySIMDOperation(LBinarySIMDOperation* instr) {
  ...
  switch (instr->op()) {
    case kFloat32x4ExtractLane: {
      ...
      DeoptimizeIf(cc, instr, DeoptimizeReason::kForcedDeoptToRuntime);
      return;
    }
