...
#define SIMD128_SWIZZLE_64x2_FUNCTIONS(V)                     \
  V(Float64x2)


#define DECLARE_SIMD_SWIZZLE_64x2_FUNCTION(TYPE)              \
RUNTIME_FUNCTION(Runtime_##TYPE##Swizzle) {                   \
  HandleScope scope(isolate);                                 \
...
SIMD128_SWIZZLE_64x2_FUNCTIONS(DECLARE_SIMD_SWIZZLE_64x2_FUNCTION)
...
#define SIMD128_SHUFFLE_64x2_FUNCTION(V)                      \
  V(Float64x2)


#define DECLARE_SIMD_SHUFFLE_64x2_FUNCTION(TYPE)              \
RUNTIME_FUNCTION(Runtime_##TYPE##Shuffle) {                   \
  HandleScope scope(isolate);                                 \
  DCHECK(args.length == 4);                                   \
                                                              \
...
SIMD128_SHUFFLE_64x2_FUNCTION(DECLARE_SIMD_SHUFFLE_64x2_FUNCTION);
